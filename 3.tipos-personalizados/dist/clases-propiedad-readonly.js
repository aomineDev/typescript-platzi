...
var Picture = /** @class */ (function (_super) {
    ...
    Picture.pictureOrientation = PictureOrientation;
    return Picture;
}(Item));
...
// picture.id = 100 // Error - readonly
picture.title = 'Another title'; // get title()
album.title = 'Personal Activities'; // get title()
console.log('album', album);
// Probando propiedad estatica - no necesitamos instancias la clase
console.log('pictureOrientation.landscape', Picture.pictureOrientation.Landscape);
